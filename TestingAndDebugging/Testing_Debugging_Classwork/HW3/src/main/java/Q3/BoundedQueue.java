...
public class BoundedQueue {
    // Overview:  a Q3.BoundedQueue is a mutable, bounded FIFO data structure
    ...
    public BoundedQueue(int capacity) {
        if (capacity < 0)
            throw new IllegalArgumentException("Q3.BoundedQueue.constructor");
    ...
    public void enQueue(Object o)
        ...
        if (o == null)
            throw new NullPointerException("Q3.BoundedQueue.enQueue");
        else if (size == capacity)
            throw new IllegalStateException("Q3.BoundedQueue.enQueue");
        else {
            size++;
            elements[back] = o;
    ...
    public Object deQueue() throws IllegalStateException {  // Modifies: this
        ...
        if (size == 0)
            throw new IllegalStateException("Q3.BoundedQueue.deQueue");
        else {
            size--;
